...
int temp_cmd(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	printf("Tj temp is %d\n",mvCtrlTjTempGet());
...
#elif defined(DB_88F6192A) || defined(DB_88F6281A) || defined(DB_88F6282A) || defined(DB_88F6701A) || defined(DB_88F6702A)
U_BOOT_CMD(SatR, 5, 1, do_satr,
	"SatR - sample at reset sub-system, relevent for DB only\n",
