...
#elif defined(MV_BOOTSIZE_1M)

#define BOOTDEV_CS_SIZE _1M
...
#if (defined(DB_MV78XX0) || defined(MV78200) || defined(RD_MV78XX0_PCAC)) && !defined(MV_SPI_BOOT)
