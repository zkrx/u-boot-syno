...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.29-TINY"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.29"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
#define VER_NUM 0x03041D00           /* 3.4.29 */
