...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING    " Marvell version: 3.5.9-TINY"
#else
#define CONFIG_IDENT_STRING    " Marvell version: 3.5.9"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
#define VER_NUM 0x03050900           /* 3.5.9 */
...
#define CONFIG_IPADDR		192.168.1.154
...
#define SYNO_GPIO_FOR_6282_1_2_BAY
#define SYNO_OPTION_6282_PHY_WOL
#define SYNO_FAN_WITH_PWM_CTL /* No control mpp 15,16,17 */
#define CONFIG_BOOTCOMMAND	"bootm F8080000 F8280000"
#define CONFIG_BOOTARGS         "console=ttyS0,115200 ip=off initrd=0x00800040,4M"
#define SYNO_HW_VERSION_211pr1 "DS211pv20"
#define SYNO_HW_VERSION         SYNO_HW_VERSION_211pr1
#define SYNO_BOOT_DEV           "/dev/md0"
#define SYNO_MAX_DISK           2
#define SYNO_POWERON_SEQ		2
#define SYNO_MAX_FAN            1
#define SYNO_NETIF_NUM          1
#define CONFIG_CUSTOM_BOOTARGS  "root=%s rw syno_hw_version=%s ihd_num=%d netif_num=%d esata_7042=1"
