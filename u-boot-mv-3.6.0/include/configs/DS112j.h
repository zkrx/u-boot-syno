...
#define SYNO_HW_VERSION_112j "DS112jv10"
#define SYNO_HW_VERSION         SYNO_HW_VERSION_112j
#define SYNO_BOOT_DEV           "/dev/sda1"
#define SYNO_MAX_DISK           1
#define SYNO_POWERON_SEQ		0	
#define SYNO_MAX_FAN            1
#define SYNO_NETIF_NUM          1
#define CONFIG_CUSTOM_BOOTARGS  "root=%s rw syno_hw_version=%s ihd_num=%d netif_num=%d"
