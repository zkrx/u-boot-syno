...
#if defined(DB_88F6280A) || defined(RD_88F6282A)
...
//#define CONFIG_ROOTPATH    /srv/ubuntu
...
#define SYNO_GPIO_FOR_6282_RS
#define CONFIG_BOOTCOMMAND	"bootm F8080000 F8280000"
#define CONFIG_BOOTARGS         "console=ttyS0,115200 ip=off initrd=0x00800040,4M"
#define SYNO_HW_VERSION_RS212   "RS212"
#define SYNO_HW_VERSION         SYNO_HW_VERSION_RS212
#define SYNO_BOOT_DEV           "/dev/md0"
#define SYNO_MAX_DISK           2
#define SYNO_POWERON_SEQ		0
#define SYNO_MAX_FAN            3
#define SYNO_NETIF_NUM          2
#define CONFIG_CUSTOM_BOOTARGS  "root=%s rw syno_hw_version=%s ihd_num=%d netif_num=%d netif_seq=10 DiskSeqReverse=2"
