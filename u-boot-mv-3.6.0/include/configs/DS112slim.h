...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING	" Marvell version: 3.6.0-TINY"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.6.0"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
#define VER_NUM 0x03060000           /* 3.6.0 */
...
#define CONFIG_CMD_BASIC ( CFG_CMD_FLASH \
			 | CFG_CMD_I2C \
			 | CFG_CMD_NET \
			 | CFG_CMD_MEMORY \
			 | CFG_CMD_PING \
...
#define CONFIG_COMMANDS CONFIG_CMD_BASIC
...
/************/
    ...
    defined(MV88F6192) || defined(MV88F6180) || defined(MV88F6280) || defined(MV88F6701) ||  defined(MV88F6702)
#define CONFIG_MMC
...
#define CONFIG_AUTOBOOT_DELAY_STR (char []){CTRL('D'), 0}        
...
#define SYNO_OPTION_6282_PHY_WOL
#define CONFIG_BOOTCOMMAND 	"usb start; vendor usb 0:2 /vendor; checksumcmd usb 400000 /zImage 800000 /rd.bin; bootm 400000 800000"
#define CONFIG_BOOTARGS         "console=ttyS0,115200 ip=off initrd=0x800040,1M"
#define SYNO_HW_VERSION_112slim "DS112slim"
#define SYNO_HW_VERSION         SYNO_HW_VERSION_112slim
#define SYNO_BOOT_DEV           "/dev/sda1"
#define SYNO_RAM_DEV			"/dev/ram"
#define SYNO_MAX_DISK           1
#define SYNO_POWERON_SEQ		0	
#define SYNO_MAX_FAN            0
#define SYNO_NETIF_NUM          1
#define CONFIG_CUSTOM_BOOTARGS  "root=%s rw syno_hw_version=%s ihd_num=%d netif_num=%d syno_dyn_module=y"
#define SYNO_RANDOMIZE_MAC
/* Boot system from onboard USB storage device */
#define SYNO_USBBOOT
#define SYNO_USBBOOT_ID_VENDOR  0xF400
#define SYNO_USBBOOT_ID_PRODUCT 0xF400
#define SYNO_USBMAN_ID_VENDOR   0xF401
#define SYNO_USBMAN_ID_PRODUCT  0xF401
#define SYNO_VENDOR
#define SYNO_CHECKSUM
/* Shorten some delay loops to boot quicker */
#define SYNO_QUICKER_BOOT
