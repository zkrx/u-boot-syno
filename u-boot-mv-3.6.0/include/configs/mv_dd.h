...
/************/
#ifdef MV632X
#define BUILD_TAG  "1.0.4"
#ifdef DUAL_OS_78200
#define CONFIG_IDENT_STRING	" Marvell version: 1.0.4 - Dual CPU"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 1.0.4"
#endif

/* version number passing when loading Kernel */
#define VER_NUM 0x01000400           /* 1.0.4 */
#else
#define BUILD_TAG  "3.3.28"
#ifdef DUAL_OS_78200
#define CONFIG_IDENT_STRING	" Marvell version: 3.3.28 - Dual CPU"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.3.28"
#endif

/* version number passing when loading Kernel */
#define VER_NUM 0x03031c00           /* 3.3.28 */
#endif
