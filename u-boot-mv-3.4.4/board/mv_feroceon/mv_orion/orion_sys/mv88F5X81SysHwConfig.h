...
#if defined(RD_88F5181_GTWGE) || defined (RD_88F5181_GTWFE)
/* On-Board Marvell Switch */
...
#if defined(DB_VOIP)
/* On-Board Telephony SLIC */
#define MV_INC_BOARD_SLIC
/* On-Board TDM FPGA */
#define MV_INC_BOARD_TDM_FPGA
/* On-Board Marvell Switch */
#define MV_INC_BOARD_QD_SWITCH
...
#undef MV_INC_BOARD_DDIM
 ...
 #undef PCI1_IF_MODE
 #define PCI1_IF_MODE    PCI_IF_MODE_DEVICE
#endif

#endif /* defined(DB_PRPMC) || defined (DB_PEX_PCI) */
...
#undef MV_INCLUDE_GIG_ETH
#undef MV_INCLUDE_USB
#undef MV_INCLUDE_TWSI
#undef MV_INCLUDE_NAND
#undef MV_INC_BOARD_NAND_FLASH
#undef MV_INC_BOARD_DDIM
#undef MV_MEM_OVER_PCI_WA
#undef MV_MEM_OVER_PEX_WA
#define MV_UART_OVER_PCI_WA
#endif
...
#define DEVICE_CS1_BASE 0xfa000000
#define DEVICE_CS1_SIZE _2M
#else
