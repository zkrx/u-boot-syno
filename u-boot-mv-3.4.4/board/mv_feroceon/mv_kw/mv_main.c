...
int misc_init_r (void)
{
	...
	mvBoardDebugLed(7);
		...
		if( SYNO_DS409_ID == mvBoardIdGet() ) {
			// set highest fan speed
			SYNO_MV6281_GPIO_PIN(15, &v1, 1);
			SYNO_MV6281_GPIO_PIN(16, &v1, 1);
			SYNO_MV6281_GPIO_PIN(17, &v1, 1);
			udelay(1000000);
			// set slowest fan speed
			SYNO_MV6281_GPIO_PIN(15, &v0, 1);
			SYNO_MV6281_GPIO_PIN(16, &v1, 1);
			SYNO_MV6281_GPIO_PIN(17, &v0, 1);
		} else {
			// set highest fan speed
			SYNO_MV6281_GPIO_PIN(32, &v0, 1);
			SYNO_MV6281_GPIO_PIN(33, &v0, 1);
			SYNO_MV6281_GPIO_PIN(34, &v1, 1);
			udelay(1000000);
			// set slowest fan speed
			SYNO_MV6281_GPIO_PIN(32, &v1, 1);
			SYNO_MV6281_GPIO_PIN(33, &v0, 1);
			SYNO_MV6281_GPIO_PIN(34, &v0, 1);
		}
#endif
